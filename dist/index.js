...
const marker = {
  ...
  error: err => {
    ...
    stack = stack.filter(line => !line.includes('node_modules/') && !line.includes('internal/modules/cjs') && !line.includes('internal/bootstrap'));

    for (let line of stack) {
      odd = !odd; //keep it short

      line = line.substr(line.lastIndexOf('\\') - 50); //alternating row colors
